# Django settings for asocarssgi project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'pomcastest',                      # Or path to database file if using sqlite3.
        'USER': 'asopomcas',
        'PASSWORD': 'dbAbLwEN',
...
SECRET_KEY = 'b9uq0q64=3!ixh2(wg39x_4ly#1=lx^k#0fk#*!w7__2*&q0x$'
...
ROOT_URLCONF = 'asocarssgi.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'asocarssgi.wsgi.application'
